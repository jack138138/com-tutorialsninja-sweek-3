...
public class DesktopsTest extends Utility {
    ...
    public void verifyProductArrangeInAlphabaticalOrder() {
        ...
        List<WebElement> productNames = Mydriver.findElements(By.cssSelector("div.container:nth-child(4) div.row div.col-sm-9 div.row:nth-child(7) div.product-layout.product-grid.col-lg-4.col-md-4.col-sm-6.col-xs-12:nth-child(1) div.product-thumb div:nth-child(2) div.caption h4:nth-child(1) > a:nth-child(1)"));
        ...
        Assert.assertEquals("Wrong shown",originalList, sortedList);
    }
    ...
    public void verifyProductAddedToShoppingCartSuccessFully  () {
        ...
        WebElement dateTextField = Mydriver.findElement(By.cssSelector("#input-option225"));
        dateTextField.click();
